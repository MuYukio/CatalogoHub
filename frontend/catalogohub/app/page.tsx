            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className={cn(
                  ...
                  isGames ? "bg-blue-100 dark:bg-blue-900/50" : "bg-purple-100 dark:bg-purple-900/50"
                )}>
                  <Clock className={cn("h-5 w-5", isGames ? "text-blue-600 dark:text-blue-300" : "text-purple-600 dark:text-purple-300")} />
                </div>
                <div>
                  <h2 className="text-xl font-bold flex items-center gap-2">
                    ...
                    <span className={cn(
                      ...
                      isGames ? "bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300"
                               : "bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300"
                    )}>
                      {carouselData.length} itens
                    </span>
                  </h2>
